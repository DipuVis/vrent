          ...
          <div class="margin-top10">
            <form accept-charset="UTF-8" method="post" action="{{ url('payments/book/'.$property_id) }}">
              <div class="col-md-4 col-sm-4 r-pad-none">
                ...
                <div class="">
                  <input class="form-control" id="list_checkin" name="checkin" value="{{ $checkin?date('d-m-Y',strtotime($checkin)):date('d-m-Y') }}" placeholder="dd-mm-yyyy" type="text" required>
                </div>
              </div>
              ...
              <div class="col-md-4 col-sm-4 r-pad-none">
                ...
                <div class="">
                  <input class="form-control" id="list_checkout" name="checkout" value="{{ $checkout?date('d-m-Y',strtotime($checkout)): date('d-m-Y', time() + 86400) }}" placeholder="dd-mm-yyyy" type="text" required>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-md-6 col-sm-6">
                <div>
                    ...
                    @else
                    <strong><span id="weekly_price_string">{{ $result->property_price->currency->symbol }} {{ $result->property_price->monthly_discount}}</span> /{{trans('messages.property_single.month')}}</strong>
                    @endif
                </div>
              </div>
            </div>
