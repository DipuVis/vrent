        ...
        <div class="panel-body">
          ...
          <p class="exfont">
            <small>
              ...
              <strong><span id="payment-currency">{{$currencyDefault->org_symbol}}{{$currencyDefault->code}}</span></strong>.
              {{trans('messages.payment.your_total_charge')}}
              <strong><span id="payment-total-charge">{{$currencyDefault->org_symbol}}{{ $price_eur }}</span></strong>.
              {{trans('messages.payment.exchange_rate_booking')}} {{$currencyDefault->org_symbol}} 1 to {{ $result->property_price->currency->org_symbol }}{{ $price_rate }} {{ $result->property_price->currency_code }} (your host's listing currency).
            </small>
          </p>
        </div>
      </div>
